...
read_file(ARGV.first) do |row|
    ...
    `java -mx300m -classpath stanford-postagger.jar edu.stanford.nlp.tagger.maxent.MaxentTagger -model models/bidirectional-wsj-0-18.tagger -prop myPropsFile.prop -textFile tmp_in.dat > tmp_out.dat`
